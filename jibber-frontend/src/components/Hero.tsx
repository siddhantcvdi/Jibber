    ...
    <div className="relative overflow-hidden flex flex-col items-center justify-center py-20 px-4 md:px-6 lg:py-32 text-center">
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-center mb-6 animate-fade-in">
          <div className="bg-white p-3 rounded-2xl shadow-lg flex items-center">
        ...
        <div className="space-y-6 max-w-4xl">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 leading-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#5e63f9] to-[#a5a8ff] block mt-2">End-to-end encrypted.</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="font-medium px-8 py-6 text-lg rounded-full border-2 hover:bg-gray-50"

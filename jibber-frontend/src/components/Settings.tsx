...
const Settings = () => {
  ...
  const isPasswordValid = () => {
    return profileData.newPassword.length >= 8 && 
        ...
        <div className="max-w-2xl mx-auto p-6 space-y-6">
          ...
          <div className="flex space-x-1 bg-muted rounded-lg p-1">
            {[
              ...
              <button
                key={id}
                onClick={() => setActiveSection(id as 'profile' | 'account' | 'security')}
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">This will be used for account recovery and notifications</p>
                </div>
                ...
                {profileData.newPassword && (
                  <div className="p-3 bg-muted rounded-lg">
                    ...
                    <div className="space-y-1 text-xs">
                      <div className={`flex items-center gap-2 ${profileData.newPassword.length >= 8 ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`}>
                        <div className={`w-2 h-2 rounded-full ${profileData.newPassword.length >= 8 ? 'bg-green-500' : 'bg-muted-foreground'}`} />
                        At least 8 characters
                      </div>
                      <div className={`flex items-center gap-2 ${profileData.newPassword === profileData.confirmPassword && profileData.confirmPassword ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`}>
                        <div className={`w-2 h-2 rounded-full ${profileData.newPassword === profileData.confirmPassword && profileData.confirmPassword ? 'bg-green-500' : 'bg-muted-foreground'}`} />
                        Passwords match
                      </div>
                    </div>
                  </div>

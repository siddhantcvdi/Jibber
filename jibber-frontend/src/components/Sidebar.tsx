  ...
  return (
    <div className="h-screen w-[500px] p-2 bg-neutral-50 outline-1 outline-neutral-200 poppins-regular">
        ...
        <div className="pt-5">
            ...
            <ChatPreview name="Donald Duck" lastChatText="Tired of Winning?" icon="https://images.moneycontrol.com/static-mcnews/2024/12/20241211112438_BeFunky-collage-2024-12-11T165424.810.jpg?impolicy=website&width=770&height=431" />
            <ChatPreview name="Joe Who" lastChatText="Where am I?" icon="https://www.thoughtco.com/thmb/naT2Yc0Z1u0kz37osn29jkOSm-g=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/GettyImages-1055820900-ed9e56a18e5e464e8b00620f1174dbfa.jpg" />
        </div>
    </div>
  )
}

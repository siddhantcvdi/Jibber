...
export const contactsData: Contact[] = [
  {
    ...
    unread: 0,
    messages: [
      { text: "Hey! How's the project going?", isSentByMe: false, timestamp: "11:30 AM" },
      { text: "It's going well! Just finished the authentication pages.", isSentByMe: true, timestamp: "11:32 AM" },
      { text: "That's awesome! When can I test it?", isSentByMe: false, timestamp: "11:33 AM" },
      { text: "I'll deploy it later today. Will send you the link.", isSentByMe: true, timestamp: "11:35 AM" },
      { text: "Perfect! Looking forward to it.", isSentByMe: false, timestamp: "11:40 AM" },
      { text: "Yes, I'll be there in 5 minutes", isSentByMe: true, timestamp: "11:45 AM" },
    ]
  },
  {
    id: "4567",
  ...
  },
  {
    ...
    unread: 1,
    messages: [
      { text: "Hey, do you remember where we parked?", isSentByMe: false, timestamp: "Yesterday 3:45 PM" },
      { text: "I think it was near the mall entrance", isSentByMe: true, timestamp: "Yesterday 3:47 PM" },
      { text: "Where am I? I don't remember...", isSentByMe: false, timestamp: "Yesterday 3:50 PM" },
    ]
  },
  {
    id: "5678",
    ...
    unread: 0,
    messages: [
      { text: "Can you send me the meeting notes?", isSentByMe: false, timestamp: "Tuesday 2:15 PM" },
      { text: "Sure! I'll email them to you right now.", isSentByMe: true, timestamp: "Tuesday 2:17 PM" },
      { text: "Thanks for the information!", isSentByMe: false, timestamp: "Tuesday 2:20 PM" },
    ]
  }
];

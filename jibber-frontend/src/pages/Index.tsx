        ...
        <div className="md:hidden flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-40 p-2">
              <DropdownMenuItem onClick={(e) => smoothScroll(e, 'features')} className="p-2 cursor-pointer">
                Features
              </DropdownMenuItem>
              <DropdownMenuItem onClick={(e) => smoothScroll(e, 'security')} className="p-2 cursor-pointer">
                Security
              </DropdownMenuItem>
              <DropdownMenuItem onClick={(e) => smoothScroll(e, 'about')} className="p-2 cursor-pointer">
                About
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem 
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 relative">
              <div className="w-full lg:w-1/2 text-center lg:text-left relative z-10">
                ...
                <p className="text-muted-foreground mb-6 lg:mb-8 text-sm sm:text-base lg:text-lg max-w-lg mx-auto lg:mx-0">
                  Enterprise-grade security with zero-knowledge authentication and end-to-end encryption.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 mb-6 lg:mb-8">
                  <div className="flex items-center p-3 bg-background/50 dark:bg-card/50 rounded-xl border border-border/50">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-semibold text-foreground text-sm">Zero-Knowledge Auth</h3>
                      <p className="text-xs text-muted-foreground">OPAQUE protocol</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-3 bg-background/50 dark:bg-card/50 rounded-xl border border-border/50">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-semibold text-foreground text-sm">ECDH P-256</h3>
                      <p className="text-xs text-muted-foreground">Perfect forward secrecy</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-3 bg-background/50 dark:bg-card/50 rounded-xl border border-border/50">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-semibold text-foreground text-sm">Ed25519 Signatures</h3>
                      <p className="text-xs text-muted-foreground">Message verification</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center p-3 bg-background/50 dark:bg-card/50 rounded-xl border border-border/50">
                    ...
                    <div className="min-w-0">
                      <h3 className="font-semibold text-foreground text-sm">AES-256-GCM</h3>
                      <p className="text-xs text-muted-foreground">Authenticated encryption</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-[#f8f9ff] to-[#f0f2ff] dark:from-[#1a1b2e] dark:to-[#1e1f3a] rounded-xl p-4 mb-6 lg:mb-8 border border-[#e0e3ff] dark:border-[#2d2f6b]">
                  <div className="grid grid-cols-2 gap-3 text-xs sm:text-sm">
                    <div className="text-center">
                      <div className="font-mono text-[#5e63f9] font-bold">256-bit</div>
                      <span className="text-muted-foreground">Encryption</span>
                    </div>
                    <div className="text-center">
                      <div className="font-mono text-[#5e63f9] font-bold">Ed25519</div>
                      <span className="text-muted-foreground">Signatures</span>
                    </div>
                    <div className="text-center">
                      <div className="font-mono text-[#5e63f9] font-bold">P-256</div>
                      <span className="text-muted-foreground">ECDH</span>
                    </div>
                    <div className="text-center">
                      <div className="font-mono text-[#5e63f9] font-bold">OPAQUE</div>
                      ...
                      <div className="bg-gray-100 dark:bg-gray-800 p-3 sm:p-3 pt-8 sm:pt-9   pb-2 flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div className="ml-2 sm:ml-3">
                            <p className="font-medium dark:text-gray-100 text-xs sm:text-sm">Jibber Admin</p>
                            <div className="flex items-center">
                              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-green-500 mr-1"></div>
                              <span className="text-[10px] text-green-600 dark:text-green-400">E2E Encrypted</span>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="p-3 sm:p-5 h-[340px] sm:h-[380px] overflow-y-auto flex flex-col space-y-3 sm:space-y-5 text-xs sm:text-sm">
                        <div className="bg-gray-100 dark:bg-gray-800 p-2 sm:p-3 rounded-xl sm:rounded-2xl rounded-tl-sm max-w-[85%] self-start dark:text-gray-200 shadow-sm">
                          ...
                          <div className="flex items-center justify-between mt-1 sm:mt-2">
                            <p className="text-[9px] sm:text-[10px] text-gray-400">10:30 AM</p>
                            <div className="flex items-center space-x-1">
                              <div className="w-1 h-1 rounded-full bg-green-500"></div>
                              <span className="text-[8px] sm:text-[9px] text-green-600">Verified</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-[#5e63f9] p-2 sm:p-3 rounded-xl sm:rounded-2xl rounded-tr-sm max-w-[85%] self-end text-white shadow-sm">
                          <p>I'm good, thanks!</p>
                          <div className="flex items-center justify-between mt-1 sm:mt-2">
                            <p className="text-[9px] sm:text-[10px] text-[#e0e1ff]">10:32 AM</p>
                            <div className="flex items-center space-x-1">
                              <Fingerprint className="h-1.5 w-1.5 sm:h-2 sm:w-2 text-[#e0e1ff]" />
                              <span className="text-[8px] sm:text-[9px] text-[#e0e1ff]">Signed</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-100 dark:bg-gray-800 p-2 sm:p-3 rounded-xl sm:rounded-2xl rounded-tl-sm max-w-[85%] self-start dark:text-gray-200 shadow-sm">
                          ...
                          <div className="flex items-center justify-between mt-1 sm:mt-2">
                            <p className="text-[9px] sm:text-[10px] text-gray-400">10:33 AM</p>
                            <div className="flex items-center space-x-1">
                              <Key className="h-1.5 w-1.5 sm:h-2 sm:w-2 text-green-600" />
                              <span className="text-[8px] sm:text-[9px] text-green-600">ECDH</span>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Features</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Security</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Privacy</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Roadmap</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Help Center</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Contact Us</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Status</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Privacy Policy</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Terms of Service</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">Cookie Policy</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white text-sm cursor-pointer">GDPR</a></li>
              </ul>
            </div>
          </div>

...
const Signup = () => {
  ...
  return (
    <div className="firefox-card min-h-screen flex items-center justify-center p-4 pt-16 sm:pt-4 bg-gradient-to-br from-background via-muted/30 to-background relative overflow-hidden font-[Poppins]">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-xs text-blue-700 dark:text-blue-300">
                      <strong>Important:</strong> Please remember your password.
                      If you forget it, all your chat history will be
